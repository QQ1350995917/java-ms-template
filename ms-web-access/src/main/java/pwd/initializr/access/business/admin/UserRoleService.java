...
public interface UserRoleService {
   ...
   * @param pageIndex 页码
   * @param pageSize 容量
   * @return pwd.initializr.common.web.business.bo.PageableQueryResult<pwd.initializr.access.business.admin.bo.UserRoleBO>
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 2021-08-08 16:34
   */
    ...
    *
    * @param id 主键
    * @return pwd.initializr.access.business.admin.bo.UserRoleBO 业务对象
    * @author Automatic[www.dingpengwei@foxmail.com]
    * @since 2021-08-08 16:34
    */
