...
import pwd.initializr.access.api.vo.GroupRoleInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>GroupRole控制层接口声明</h1>
 *
...
public interface GroupRoleApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupRoleInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupRoleInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupRoleInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupRoleInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GroupRoleInput input);
