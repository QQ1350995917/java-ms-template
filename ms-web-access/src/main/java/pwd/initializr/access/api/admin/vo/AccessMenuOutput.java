...
@Setter
@ToString
@ApiModel(value = "AccessMenuInput", description = "AccessMenu响应参数")
public class AccessMenuOutput implements Serializable {
   ...
   * 外键，菜单表主键
   */
  @ApiModelProperty(name = "mid", value = "外键，菜单表主键", required = true, example = "")
