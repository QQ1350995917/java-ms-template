...
@Setter
@ToString
@ApiModel(value = "RoleMenuOperationInput", description = "RoleMenuOperation响应参数")
public class RoleMenuOperationOutput implements Serializable {
   ...
   * 外键，操作表主键
   */
  @ApiModelProperty(name = "oid", value = "外键，操作表主键", required = true, example = "")
