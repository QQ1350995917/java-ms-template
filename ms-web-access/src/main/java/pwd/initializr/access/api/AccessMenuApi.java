...
import pwd.initializr.access.api.vo.AccessMenuInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>AccessMenu控制层接口声明</h1>
 *
...
public interface AccessMenuApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessMenuInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessMenuInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessMenuInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessMenuInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") AccessMenuInput input);
