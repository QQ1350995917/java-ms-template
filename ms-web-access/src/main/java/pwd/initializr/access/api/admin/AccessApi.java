...
public interface AccessApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") AccessInput input);
