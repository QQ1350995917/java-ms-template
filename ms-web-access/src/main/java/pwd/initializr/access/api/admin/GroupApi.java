...
import pwd.initializr.access.api.admin.vo.GroupInput;
...
public interface GroupApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GroupInput input);
