...
import pwd.initializr.access.api.admin.vo.RoleInput;
...
public interface RoleApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") RoleInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") RoleInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") RoleInput input);
