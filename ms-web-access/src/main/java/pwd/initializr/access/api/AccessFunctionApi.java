...
import pwd.initializr.access.api.vo.AccessFunctionInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>AccessFunction控制层接口声明</h1>
 *
...
public interface AccessFunctionApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessFunctionInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessFunctionInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessFunctionInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessFunctionInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") AccessFunctionInput input);
