...
import pwd.initializr.access.api.vo.UserRoleInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>UserRole控制层接口声明</h1>
 *
...
public interface UserRoleApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") UserRoleInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<UserRoleInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") UserRoleInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<UserRoleInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") UserRoleInput input);
