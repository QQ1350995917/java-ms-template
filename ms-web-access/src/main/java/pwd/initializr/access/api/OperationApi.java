...
public interface OperationApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") OperationInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<OperationInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") OperationInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<OperationInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") OperationInput input);
