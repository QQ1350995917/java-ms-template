...
import pwd.initializr.access.api.vo.AccessStorageInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>AccessStorage控制层接口声明</h1>
 *
...
public interface AccessStorageApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessStorageInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessStorageInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") AccessStorageInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<AccessStorageInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") AccessStorageInput input);
