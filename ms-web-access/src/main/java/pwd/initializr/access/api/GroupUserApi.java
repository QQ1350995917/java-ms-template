...
import pwd.initializr.access.api.vo.GroupUserInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>GroupUser控制层接口声明</h1>
 *
...
public interface GroupUserApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupUserInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupUserInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GroupUserInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GroupUserInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GroupUserInput input);
