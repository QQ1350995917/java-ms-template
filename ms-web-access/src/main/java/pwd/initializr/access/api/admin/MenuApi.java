...
import pwd.initializr.access.api.admin.vo.MenuInput;
...
@RequestMapping(value = "/api/api/menu")
public interface MenuApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") MenuInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<MenuInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") MenuInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<MenuInput> input);
