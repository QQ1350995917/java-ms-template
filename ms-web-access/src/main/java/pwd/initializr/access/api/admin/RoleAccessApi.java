...
public interface RoleAccessApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") RoleAccessInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleAccessInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") RoleAccessInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleAccessInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") RoleAccessInput input);
