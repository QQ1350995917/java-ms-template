...
@Setter
@ToString
@ApiModel(value = "AccessFunctionInput", description = "AccessFunction响应参数")
public class AccessFunctionOutput implements Serializable {

  /**
   * 主键
   * 外键，权限表主键
   */
  @ApiModelProperty(name = "aid", value = "外键，权限表主键", required = true, example = "")
   @NotBlank(message = "aid不能为空")
  private Long aid;
  /**
   * 主键
   * 外键，功能表主键
   */
  @ApiModelProperty(name = "fid", value = "外键，功能表主键", required = true, example = "")
