...
import pwd.initializr.access.api.vo.FunctionInput;

/**
 * pwd-initializr-access@ms-web-initializr
 *
 * <h1>Function控制层接口声明</h1>
 *
...
public interface FunctionApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") FunctionInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<FunctionInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") FunctionInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<FunctionInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") FunctionInput input);
