 ...
 *
 * <h1>RoleMenuOperation控制层接口声明</h1>
 *
...
public interface RoleMenuOperationApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") RoleMenuOperationInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleMenuOperationInput> input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") RoleMenuOperationInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<RoleMenuOperationInput> input);
