...
@Setter
@ToString
@ApiModel(value = "AccessStorageInput", description = "AccessStorage响应参数")
public class AccessStorageOutput implements Serializable {
   ...
   * 外键，文件存储主键
   */
  @ApiModelProperty(name = "sid", value = "外键，文件存储主键", required = true, example = "")
