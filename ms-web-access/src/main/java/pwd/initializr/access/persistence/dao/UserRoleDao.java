...
public interface UserRoleDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") UserRoleEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<UserRoleEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") UserRoleEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<UserRoleEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<UserRoleEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  UserRoleEntity queryById(@Param("id") Long id);
