...
public interface MenuDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") MenuEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<MenuEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") MenuEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<MenuEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<MenuEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  MenuEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") MenuEntity entity);
}
