 ...
 */
public interface HostWhoService {
   ...
   * @param pageIndex 页码
   * @param pageSize 容量
   * @return pwd.initializr.common.web.business.bo.PageableQueryResult<pwd.initializr.monitor.business.bo.HostWhoBO>
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 2020-10-23 11:58
   */
  PageableQueryResult<HostWhoBO> queryAllByCondition(LinkedHashSet<ScopeBO> scopes,
   ...
   *
   * @param id 主键
   * @return pwd.initializr.monitor.business.bo.HostWhoBO 业务对象
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 2020-10-23 11:58
   */
  HostWhoBO queryById(Long id);
   ...
   * @since 2020-10-23 11:58
   */
  Integer updateById(HostWhoBO bo);
}
