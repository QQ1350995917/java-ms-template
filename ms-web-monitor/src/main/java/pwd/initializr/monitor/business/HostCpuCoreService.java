 ...
 */
public interface HostCpuCoreService {
   ...
   * @since DistributionVersion
   */
  void insertOrReplace(List<HostCpuCoreBO> bos);
   ...
   * @param pageIndex 页码
   * @param pageSize 容量
   * @return pwd.initializr.common.web.business.bo.PageableQueryResult<pwd.initializr.monitor.business.bo.HostCpuCoreBO>
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 2020-10-23 11:58
   */
  PageableQueryResult<HostCpuCoreBO> queryAllByCondition(LinkedHashSet<ScopeBO> scopes,
   ...
   *
   * @param id 主键
   * @return pwd.initializr.monitor.business.bo.HostCpuCoreBO 业务对象
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 2020-10-23 11:58
   */
  HostCpuCoreBO queryById(Long id);
   ...
   * @since 2020-10-23 11:58
   */
  Integer updateById(HostCpuCoreBO bo);
}
