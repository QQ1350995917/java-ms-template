...
public interface HostLoggedStatApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostLoggedStatInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<HostLoggedStatInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input);
