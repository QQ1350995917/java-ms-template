...
public interface HostLoadStatApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostLoadStatInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostLoadStatInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostLoadStatInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<HostLoadStatInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostLoadStatInput input);
