...
import pwd.initializr.monitor.api.robot.vo.HostLoggedStatInput;
import pwd.initializr.monitor.api.robot.vo.HostLoggedStatOutput;
...
public class HostLoggedStatController extends pwd.initializr.common.web.api.admin.AdminController implements HostLoggedStatApi {
  ...
  @Override
  public void create(@Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input) {
  ...
  @Override
  public void create(@Valid @NotNull(message = "参数不能为空") List<HostLoggedStatInput> input) {
    LinkedList<HostLoggedStatBO> bos = new LinkedList<>();
    for (HostLoggedStatInput item : input) {
      HostLoggedStatBO bo = new HostLoggedStatBO();
  ...
  @Override
  public void createOrReplace(@Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input) {
    HostLoggedStatBO bo = new HostLoggedStatBO();
    BeanUtils.copyProperties(input,bo);
  ...
  @Override
  public void createOrReplace(@Valid @NotNull(message = "参数不能为空") List<HostLoggedStatInput> input) {
    LinkedList<HostLoggedStatBO> bos = new LinkedList<>();
    for (HostLoggedStatInput item : input) {
      HostLoggedStatBO bo = new HostLoggedStatBO();
      BeanUtils.copyProperties(item,bo);
  ...
  @Valid @NotNull(message = "参数不能为空") HostLoggedStatInput input) {
    HostLoggedStatBO bo = new HostLoggedStatBO();
    BeanUtils.copyProperties(input,bo);
