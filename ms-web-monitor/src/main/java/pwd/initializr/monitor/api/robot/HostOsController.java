...
@Slf4j
public class HostOsController extends pwd.initializr.common.web.api.admin.AdminController implements HostOsApi {
  ...
  @Override
  public void create(@Valid @NotNull(message = "参数不能为空") HostOsInput input) {
