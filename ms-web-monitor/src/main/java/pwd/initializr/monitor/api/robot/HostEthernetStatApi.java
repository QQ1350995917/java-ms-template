...
public interface HostEthernetStatApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostEthernetStatInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostEthernetStatInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostEthernetStatInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<HostEthernetStatInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostEthernetStatInput input);
