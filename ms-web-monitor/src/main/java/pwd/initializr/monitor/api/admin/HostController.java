...
import pwd.initializr.monitor.api.admin.vo.HostOutput;
...
@Api(
    tags = "AdminHost信息结构",
    value = "AdminHostManageApi",
    description = "[列表查询，详情查询，启/禁用，删除，新增，修改]"
)
@RestController(value = "AdminHost")
@RequestMapping(value = "/api/admin/host")
@Slf4j
public class HostController extends pwd.initializr.common.web.api.admin.AdminController implements
    HostApi {
