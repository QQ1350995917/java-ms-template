...
public interface HostMemoryStatApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostMemoryStatInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostMemoryStatInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostMemoryStatInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<HostMemoryStatInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostMemoryStatInput input);
