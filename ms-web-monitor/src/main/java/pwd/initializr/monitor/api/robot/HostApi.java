...
@RequestMapping(value = "/api/robt/host")
public interface HostApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostInput input);
