...
public interface HostDiskStatApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") HostDiskStatInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostDiskStatInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") HostDiskStatInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<HostDiskStatInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") HostDiskStatInput input);
