...
public interface HostCpuCoreUsageApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<HostCpuCoreUsageInput> input);
