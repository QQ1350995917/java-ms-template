 ...
 */
@Mapper
public interface HostCpuStatDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostCpuStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<HostCpuStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") HostCpuStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<HostCpuStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostCpuStatEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostCpuStatEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostCpuStatEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostCpuStatEntity entity);
}
