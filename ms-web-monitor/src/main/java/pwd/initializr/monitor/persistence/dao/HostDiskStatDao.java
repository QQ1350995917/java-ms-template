 ...
 */
@Mapper
public interface HostDiskStatDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostDiskStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<HostDiskStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") HostDiskStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<HostDiskStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostDiskStatEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostDiskStatEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostDiskStatEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostDiskStatEntity entity);
}
