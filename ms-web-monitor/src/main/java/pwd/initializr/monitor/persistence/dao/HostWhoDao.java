...
public interface HostWhoDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostWhoEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostWhoEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostWhoEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostWhoEntity entity);
}
