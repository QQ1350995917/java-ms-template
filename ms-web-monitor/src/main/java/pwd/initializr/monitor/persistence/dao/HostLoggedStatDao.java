 ...
 */
@Mapper
public interface HostLoggedStatDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostLoggedStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<HostLoggedStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") HostLoggedStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<HostLoggedStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostLoggedStatEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostLoggedStatEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostLoggedStatEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostLoggedStatEntity entity);
}
