 ...
 */
@Mapper
public interface HostMemoryDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostMemoryEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostMemoryEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostMemoryEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostMemoryEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostMemoryEntity entity);
}
