 ...
 */
@Mapper
public interface HostEthernetStatDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<HostEthernetStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") HostEthernetStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<HostEthernetStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostEthernetStatEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostEthernetStatEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostEthernetStatEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostEthernetStatEntity entity);
}
