 ...
 */
@Mapper
public interface HostCpuCoreDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostCpuCoreEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostCpuCoreEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostCpuCoreEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostCpuCoreEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostCpuCoreEntity entity);
}
