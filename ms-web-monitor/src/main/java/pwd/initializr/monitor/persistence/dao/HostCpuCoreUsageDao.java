...
/**
 * <h2>host_cpu_core_usage数据表操作</h2>
 ...
 */
@Mapper
public interface HostCpuCoreUsageDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostCpuCoreUsageEntity entity);
   ...
   */
  Integer insertBatch(@Param("entities") List<HostCpuCoreUsageEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostCpuCoreUsageEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostCpuCoreUsageEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostCpuCoreUsageEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostCpuCoreUsageEntity entity);
}
