 ...
 */
@Mapper
public interface HostMemorySwapDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostMemorySwapEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostMemorySwapEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostMemorySwapEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostMemorySwapEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostMemorySwapEntity entity);
}
