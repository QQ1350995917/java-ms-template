 ...
 */
@Mapper
public interface HostDiskUsageDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostDiskUsageEntity entity);
   ...
   */
  Integer insertBatch(@Param("entities") List<HostDiskUsageEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostDiskUsageEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostDiskUsageEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostDiskUsageEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostDiskUsageEntity entity);
}
