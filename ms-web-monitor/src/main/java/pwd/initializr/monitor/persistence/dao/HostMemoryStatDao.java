 ...
 */
@Mapper
public interface HostMemoryStatDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") HostMemoryStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<HostMemoryStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") HostMemoryStatEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<HostMemoryStatEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostMemoryStatEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostMemoryStatEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostMemoryStatEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostMemoryStatEntity entity);
}
