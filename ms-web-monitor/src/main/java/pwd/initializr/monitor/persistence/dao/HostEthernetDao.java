 ...
 */
@Mapper
public interface HostEthernetDao {
   ...
   * @since DistributionVersion
   */
  Integer insertOrReplaceBatch(@Param("entities") List<HostEthernetEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<HostEthernetEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return HostEthernetEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  HostEthernetEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") HostEthernetEntity entity);
}
