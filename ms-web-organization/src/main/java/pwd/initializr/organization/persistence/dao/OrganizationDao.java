...
public interface OrganizationDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") OrganizationEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<OrganizationEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") OrganizationEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<OrganizationEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<OrganizationEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") OrganizationEntity entity);
}
