...
public class ReviewPendingOutput extends ReviewPendingInput {
  ...
  @NotNull(message = "0")
  private Long id;
  @ApiModelProperty(name = "editorId", value = "编辑人者ID", required = true, example = "1")
  @NotNull(message = "0")
  private Long editorId;
  @ApiModelProperty(name = "type", value = "数据类型", required = true, example = "1")
  @Null(message = "0")
  ...
  @ApiModelProperty(name = "orgId", value = "数据状态", required = true, example = "1")
  @NotNull(message = "0")
