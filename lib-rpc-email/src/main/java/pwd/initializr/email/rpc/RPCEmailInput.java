...
public class RPCEmailInput implements Serializable {
  ...
  @ApiModelProperty(name = "appName", value = "appName", required = true, dataType = "java.lang.String")
  ...
  @ApiModelProperty(name = "attachment", value = "attachment", required = false, dataType = "java.utls.List<pwd.initializr.email.rpc.RPCEmailAttachmentVO>")
  private List<RPCEmailAttachmentVO> attachment;
