...
public interface GrammarBookExamApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookExamInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarBookExamInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookExamInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarBookExamInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookExamInput input);
