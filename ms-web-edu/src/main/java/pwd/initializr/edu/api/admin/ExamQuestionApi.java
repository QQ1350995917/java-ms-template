...
public interface ExamQuestionApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") ExamQuestionInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ExamQuestionInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") ExamQuestionInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<ExamQuestionInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") ExamQuestionInput input);
