...
public interface ArticleTableApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") ArticleTableInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ArticleTableInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") ArticleTableInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ArticleTableInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
    @RequestBody @Valid @NotNull(message = "参数不能为空") ArticleTableInput input);
