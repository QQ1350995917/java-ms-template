...
public interface ReadingTableApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") ReadingTableInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ReadingTableInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") ReadingTableInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<ReadingTableInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") ReadingTableInput input);
