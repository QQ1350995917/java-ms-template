...
public interface GrammarBookApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarBookInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarBookInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GrammarBookInput input);
