...
public interface EduTermCourseApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EduTermCourseInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<EduTermCourseInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") EduTermCourseInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<EduTermCourseInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") EduTermCourseInput input);
