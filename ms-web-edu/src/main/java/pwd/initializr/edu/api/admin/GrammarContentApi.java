...
public interface GrammarContentApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarContentInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarContentInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") GrammarContentInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<GrammarContentInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") GrammarContentInput input);
