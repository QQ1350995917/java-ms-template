 ...
 *
 * <h1>EduTermCourseTextbook控制层接口声明</h1>
 *
...
public interface EduTermCourseTextbookApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EduTermCourseTextbookInput input);
  ...
  void create(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<EduTermCourseTextbookInput> input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") EduTermCourseTextbookInput input);
