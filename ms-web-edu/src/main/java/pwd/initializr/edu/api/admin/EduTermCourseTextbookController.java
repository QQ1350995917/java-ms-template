...
import pwd.initializr.edu.api.admin.vo.EduTermCourseTextbookInput;
import pwd.initializr.edu.api.admin.vo.EduTermCourseTextbookOutput;
 ...
 */
@Api(
  tags = "EduTermCourseTextbook信息结构",
  value = "EduTermCourseTextbookManageApi",
  description = "[列表查询，详情查询，启/禁用，删除，新增，修改]"
)
@RestController(value = "EduTermCourseTextbook")
@RequestMapping(value = "/api/edu/term/course/textbook")
@Slf4j
public class EduTermCourseTextbookController extends pwd.initializr.common.web.api.admin.AdminController implements EduTermCourseTextbookApi {

  @Autowired
  private EduTermCourseTextbookService service;
  ...
  public void list(String scopes, String sorts, String page) {
    ...
    PageableQueryResult<EduTermCourseTextbookBO> pageableQueryResult = service.queryAllByCondition(scopeBOS,
      sortBOS, pageInput.getIndex(), pageInput.getSize());
    PageOutput<EduTermCourseTextbookOutput> result = new PageOutput<>();
    pageableQueryResult.getElements().forEach(bo -> {
      EduTermCourseTextbookOutput output = new EduTermCourseTextbookOutput();
  ...
  public void detail(@Valid @NotNull(message = "参数不能为空") Long id) {
    EduTermCourseTextbookBO bo = service.queryById(id);
    EduTermCourseTextbookOutput output = new EduTermCourseTextbookOutput();
    BeanUtils.copyProperties(bo,output);
    outputData(output);
  }
  ...
  @Override
  public void create(@Valid @NotNull(message = "参数不能为空") EduTermCourseTextbookInput input) {
  ...
  @Override
  public void create(@Valid @NotNull(message = "参数不能为空") List<EduTermCourseTextbookInput> input) {
  List<EduTermCourseTextbookBO> bos = input.stream().map(this::convertEduTermCourseTextbookInput2EduTermCourseTextbookBO)
  ...
  @Override
  public void createOrReplace(@Valid @NotNull(message = "参数不能为空") EduTermCourseTextbookInput input) {
    EduTermCourseTextbookBO bo = new EduTermCourseTextbookBO();
    BeanUtils.copyProperties(input,bo);
  ...
  @Override
  public void createOrReplace(@Valid @NotNull(message = "参数不能为空") List<EduTermCourseTextbookInput> input) {
  List<EduTermCourseTextbookBO> bos = input.stream().map(this::convertEduTermCourseTextbookInput2EduTermCourseTextbookBO)
    .collect(Collectors.toList());
  ...
  public void update(@Valid @NotNull(message = "参数不能为空") Long id,
    @Valid @NotNull(message = "参数不能为空") EduTermCourseTextbookInput input) {
    EduTermCourseTextbookBO bo = new EduTermCourseTextbookBO();
    BeanUtils.copyProperties(input,bo);
    bo.setId(id);
  ...
  private EduTermCourseTextbookBO convertEduTermCourseTextbookInput2EduTermCourseTextbookBO(EduTermCourseTextbookInput input){
    EduTermCourseTextbookBO bo = new EduTermCourseTextbookBO();
    BeanUtils.copyProperties(input,bo);
    return bo;
  }
