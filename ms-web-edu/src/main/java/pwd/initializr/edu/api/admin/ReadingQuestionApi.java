...
public interface ReadingQuestionApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") ReadingQuestionInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ReadingQuestionInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") ReadingQuestionInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<ReadingQuestionInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") ReadingQuestionInput input);
