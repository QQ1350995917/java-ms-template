...
public interface ExamQuestionDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") ExamQuestionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<ExamQuestionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") ExamQuestionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<ExamQuestionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<ExamQuestionEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  ExamQuestionEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") ExamQuestionEntity entity);
}
