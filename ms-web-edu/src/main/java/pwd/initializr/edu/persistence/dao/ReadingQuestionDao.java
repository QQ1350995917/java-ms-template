...
public interface ReadingQuestionDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") ReadingQuestionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<ReadingQuestionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") ReadingQuestionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<ReadingQuestionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<ReadingQuestionEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  ReadingQuestionEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") ReadingQuestionEntity entity);
}
