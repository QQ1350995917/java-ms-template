...
/**
 * <h2>edu_term_course_textbook数据表操作</h2>
 ...
 */
@Mapper
public interface EduTermCourseTextbookDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") EduTermCourseTextbookEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<EduTermCourseTextbookEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") EduTermCourseTextbookEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<EduTermCourseTextbookEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<EduTermCourseTextbookEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return EduTermCourseTextbookEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  EduTermCourseTextbookEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") EduTermCourseTextbookEntity entity);
