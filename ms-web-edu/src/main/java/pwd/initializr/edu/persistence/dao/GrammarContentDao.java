 ...
 */
@Mapper
public interface GrammarContentDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") GrammarContentEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<GrammarContentEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") GrammarContentEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<GrammarContentEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<GrammarContentEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return GrammarContentEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  GrammarContentEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") GrammarContentEntity entity);
}
