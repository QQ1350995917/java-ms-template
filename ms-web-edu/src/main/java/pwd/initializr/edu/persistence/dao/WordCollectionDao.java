...
public interface WordCollectionDao {
  ...
  Integer ableByIdAndBookId(@Param("id") Long id, @Param("bookId") String bookId, @Param("able") Integer able, @Param("date") Date date);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") WordCollectionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<WordCollectionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") WordCollectionEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<WordCollectionEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<WordCollectionEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  WordCollectionEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") WordCollectionEntity entity);
}
