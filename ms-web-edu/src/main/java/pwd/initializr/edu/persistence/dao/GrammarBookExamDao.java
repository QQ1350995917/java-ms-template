 ...
 */
@Mapper
public interface GrammarBookExamDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") GrammarBookExamEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<GrammarBookExamEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") GrammarBookExamEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<GrammarBookExamEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<GrammarBookExamEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return GrammarBookExamEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  GrammarBookExamEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") GrammarBookExamEntity entity);
}
