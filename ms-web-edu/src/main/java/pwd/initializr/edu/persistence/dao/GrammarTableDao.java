 ...
 */
@Mapper
public interface GrammarTableDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") GrammarTableEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<GrammarTableEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") GrammarTableEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<GrammarTableEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<GrammarTableEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return GrammarTableEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  GrammarTableEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") GrammarTableEntity entity);
}
