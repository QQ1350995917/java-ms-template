 ...
 */
@Mapper
public interface GrammarBookDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") GrammarBookEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<GrammarBookEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") GrammarBookEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<GrammarBookEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<GrammarBookEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return GrammarBookEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  GrammarBookEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") GrammarBookEntity entity);
}
