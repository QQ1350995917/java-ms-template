...
/**
 * <h2>edu_term_course_textbook_article数据表操作</h2>
 ...
 */
@Mapper
public interface EduTermCourseTextbookArticleDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") EduTermCourseTextbookArticleEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<EduTermCourseTextbookArticleEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") EduTermCourseTextbookArticleEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(
      @Param("entities") List<EduTermCourseTextbookArticleEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<EduTermCourseTextbookArticleEntity> queryByCondition(
   ...
   *
   * @param id 主键
   * @return EduTermCourseTextbookArticleEntity
   * @author Automatic[www.dingpengwei@foxmail.com]
   * @since 0.0.1-SNAPSHOT
   */
  EduTermCourseTextbookArticleEntity queryById(@Param("id") Long id);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") EduTermCourseTextbookArticleEntity entity);
