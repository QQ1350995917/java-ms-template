...
public class CaptchaGoogleCode extends CaptchaHelper {
    ...
    private Config createConfig(){
        ...
        //图片实现类
        properties.setProperty("kaptcha.producer.scanner", "com.google.code.kaptcha.scanner.DefaultKaptcha");
        //文本实现类
        properties.setProperty("kaptcha.textproducer.scanner", "com.google.code.kaptcha.text.scanner.DefaultTextCreator");
        //文本集合，验证码值从此集合中获取
        ...
        //干扰实现类
        properties.setProperty("kaptcha.noise.scanner", "com.google.code.kaptcha.scanner.DefaultNoise");
        //干扰颜色
        properties.setProperty("kaptcha.noise.color", "blue");
        //干扰图片样式
        properties.setProperty("kaptcha.obscurificator.scanner", "com.google.code.kaptcha.scanner.WaterRipple");
        //背景实现类
        properties.setProperty("kaptcha.background.scanner", "com.google.code.kaptcha.scanner.DefaultBackground");
        //背景颜色渐变，结束颜色
        properties.setProperty("kaptcha.background.clear.to", "white");
        //文字渲染器
        properties.setProperty("kaptcha.word.scanner", "com.google.code.kaptcha.text.scanner.DefaultWordRenderer");
