...
public interface AdminAccountDao {
   ...
   * @return 对象列表
   */
  List<AdminAccountEntity> queryAll(AdminAccountEntity adminAccountEntity);
   ...
   * @return 对象列表
   */
  List<AdminAccountEntity> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
