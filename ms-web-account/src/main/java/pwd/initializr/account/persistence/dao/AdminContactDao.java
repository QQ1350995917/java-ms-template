...
public interface AdminContactDao {
   ...
   * @return 对象列表
   */
  List<AdminContactEntity> queryAllByCondition(@Param("adminContactEntity") AdminContactEntity adminContactEntity,@Param("offset") int offset, @Param("limit") int limit);
   ...
   * @return 对象列表
   */
  List<AdminContactEntity> countAllByCondition(@Param("adminContactEntity") AdminContactEntity adminContactEntity);
