...
public interface UserContactDao {
   ...
   * @return 对象列表
   */
  List<UserContactEntity> countAllByCondition(
      @Param("adminContactEntity") UserContactEntity userContactEntity);
   ...
   * @return 对象列表
   */
  List<UserContactEntity> queryAllByCondition(
      @Param("adminContactEntity") UserContactEntity userContactEntity, @Param("offset") int offset,
