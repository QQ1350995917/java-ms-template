...
public interface SessionService {
   ...
   * @return pwd.initializr.account.business.user.bo.CaptchaBO
   * @author DingPengwei[www.dingpengwei@foxmail.com]
   * @since DistributionVersion
   */
  CaptchaBO createCaptcha(String cookie);
   ...
   * @since DistributionVersion
   */
  void createSession(String token, NamedSessionBO namedSessionBO);
   ...
   * @since DistributionVersion
   */
  AnonymousSessionBO queryCookie(String cookie);
   ...
   *
   * @param uid 用户用户ID
   * @return pwd.initializr.account.business.user.bo.NamedSessionBO
   * @author DingPengwei[www.dingpengwei@foxmail.com]
   * @since DistributionVersion
   */
  NamedSessionBO querySession(Long uid);

  /**
   * <h2>cookie更新接口，更新cookie对应的登录错误次数</h2>
   * date 2020-07-23 23:08
   *
   * @param anonymousSessionBO cookie对象
   * @return pwd.initializr.account.business.user.bo.AnonymousSessionBO 更新后的cookie对象
   * @author DingPengwei[www.dingpengwei@foxmail.com]
   * @since DistributionVersion
   */
  void updateCookie(String cookie, AnonymousSessionBO anonymousSessionBO);
   ...
   * @since DistributionVersion
   */
  Integer updateSession(NamedSessionBO namedSessionBO);
