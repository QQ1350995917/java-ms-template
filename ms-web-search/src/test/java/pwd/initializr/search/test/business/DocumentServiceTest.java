...
public class DocumentServiceTest {
  ...
  public void createV0() {
    Map<String, Object> bo0 = new HashMap<>();
    bo0.put("pub",0);
    bo0.put("age",20);
    bo0.put("status",3);
    bo0.put("content","一二三");
    ...
    documentBOS.add(
        new DocumentBO(
            ...
            Arrays.asList("xxx三国演义xxx","xxx三国xxx"),
            bo1,
            "http://www.sanguoyanyi.com",
            "20200501")
    );

    Map<String, Object> bo2 = new HashMap<>();
    bo2.put("pub",0);
    bo2.put("age",100);
    bo2.put("status",3);
    bo2.put("content","一二三四五");
    documentBOS.add(
        new DocumentBO(
            "3",
            "1",
            ...
            Arrays.asList("xxx水浒传xxx","xxx水浒xxx"),
            bo2,
            "http://www.shuihuzhuan.com",
            "20200502")
    );

    Map<String, Object> bo3 = new HashMap<>();
    bo3.put("pub",100);
    bo3.put("age",200);
    bo3.put("status",300);
    bo3.put("content","一二三四五");
    documentBOS.add(
        new DocumentBO(
            "4",
            "1",
            "水浒",
            Arrays.asList("施耐庵").stream().collect(Collectors.toSet()),
            Arrays.asList("xxx水浒xxx","xxx水浒xxx"),
            bo3,
            "http://www.shuihuzhuan.com",
            "20200502")
    );
    documentBOS.add(
        new DocumentBO(
            ...
            Arrays.asList("xxx西游记xxx","xxx西游记xxx"),
            null,
            "http://www.xiyouji.com",
            "20200503")
    );
    documentBOS.add(
        new DocumentBO(
            ...
            Arrays.asList("xxx红楼梦xxx","xxx红楼xxx"),
            null,
            "http://www.hongloumeng.com",
            "20200504")
    );
    documentBOS.add(
        new DocumentBO(
            ...
            Arrays.asList("xxx三国演义xxx","xxx水浒传xxx","xxx西游记xxx","xxx红楼梦xxx"),
            null,
            "http://www.sidamingzhu.com",
            "20200505"))
    ;
    documentBOS.add(
        new DocumentBO(
            ...
            null,
            "http://culture.gog.cn/system/2017/08/23/016027361.shtml",
            "20070731"))
    ;
  ...
  public void query(){
    ...
    PageableQueryResult<RPCSearchOutput> searchBodyVOBOPageableQueryResult = documentService.query(null);
