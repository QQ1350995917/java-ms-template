    ...
    <${className}BO> bos);
      ...
      */
      ...
      <${className}BO> bos);
        ...
        * @param pageIndex 页码
        * @param pageSize 容量
        * @return pwd.initializr.common.web.business.bo.PageableQueryResult<${projectPackage}
        .business.bo.${className}BO>
        * @author Automatic[www.dingpengwei@foxmail.com]
        * @since ${projectCreateDate}
        */
        PageableQueryResult
