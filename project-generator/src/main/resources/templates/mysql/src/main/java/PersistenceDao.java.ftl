...
public interface ${className}Dao {
   ...
   * @since ${projectVersion}
   */
  Integer ableByIds(@Param("ids") Set
<Long> ids, @Param("able") int able, @Param("date") Date date);
  ...
  * @since ${projectVersion}
  */
  Integer deleteByIds(@Param("ids") Set
  <Long> ids, @Param("date") Date date);
    ...
    * @since ${projectVersion}
    */
    Integer insertByBatch(@Param("entities") List
    <${className}Entity> entities);
      ...
      * @since ${projectVersion}
      */
      Integer insertOrReplaceByBatch(@Param("entities") List
      <${className}Entity> entities);
        ...
        */
        List
        <${className}Entity> queryByCondition(
