...
import ${projectPackage}.api.vo.${className}Input;
import ${projectPackage}.api.vo.${className}Output;
import ${projectPackage}.business.${className}Service;
...
public class ${className}Controller extends pwd.initializr.common.web.api.admin.AdminController implements ${className}Api {
  ...
  public void list(String scopes, String sorts, String page) {
    ...
    PageableQueryResult<${className}BO> pageableQueryResult = service
