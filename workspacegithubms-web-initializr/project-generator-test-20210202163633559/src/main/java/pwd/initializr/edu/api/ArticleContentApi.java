...
/**
 * project-generator-test-20210202163633559@ms-web-initializr
 *
 * <h1>ArticleContent控制层接口声明</h1>
 *
...
public interface ArticleContentApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") ArticleContentInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ArticleContentInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") ArticleContentInput input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") List<ArticleContentInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
    @RequestBody @Valid @NotNull(message = "参数不能为空") ArticleContentInput input);
