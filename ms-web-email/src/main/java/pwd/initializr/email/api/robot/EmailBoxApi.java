...
public interface EmailBoxApi {
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailBoxInput input);
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailBoxInput> input);
    ...
    void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailBoxInput input);
    ...
    void createOrReplace(
        @RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailBoxInput> input);
    ...
    void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
        @RequestBody @Valid @NotNull(message = "参数不能为空") EmailBoxInput input);
