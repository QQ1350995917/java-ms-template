...
public interface EmailExtendApi {
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailExtendInput input);
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailExtendInput> input);
    ...
    void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailExtendInput input);
    ...
    void createOrReplace(
        @RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailExtendInput> input);
    ...
    void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
        @RequestBody @Valid @NotNull(message = "参数不能为空") EmailExtendInput input);
