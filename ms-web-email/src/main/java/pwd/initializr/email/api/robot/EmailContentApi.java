...
public interface EmailContentApi {
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailContentInput input);
    ...
    void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailContentInput> input);
    ...
    void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailContentInput input);
    ...
    void createOrReplace(
        @RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailContentInput> input);
    ...
    void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
        @RequestBody @Valid @NotNull(message = "参数不能为空") EmailContentInput input);
