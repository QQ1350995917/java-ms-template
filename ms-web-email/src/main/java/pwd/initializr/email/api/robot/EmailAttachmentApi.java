...
public interface EmailAttachmentApi {
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailAttachmentInput input);
  ...
  void create(@RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailAttachmentInput> input);
  ...
  void createOrReplace(@RequestBody @Valid @NotNull(message = "参数不能为空") EmailAttachmentInput input);
  ...
  void createOrReplace(
      @RequestBody @Valid @NotNull(message = "参数不能为空") List<EmailAttachmentInput> input);
  ...
  void update(@PathVariable("id") @Valid @NotNull(message = "参数不能为空") Long id,
      @RequestBody @Valid @NotNull(message = "参数不能为空") EmailAttachmentInput input);
