...
public interface EmailService {
   ...
   * @return 实例对象
   */
  EmailBO insert(EmailBO adminAccountBO);
   ...
   * @param pageIndex 页码
   * @param pageSize 容量
   * @return @return pwd.initializr.common.web.business.bo.PageableQueryResult<EmailBO>
   * @author DingPengwei[www.dingpengwei@foxmail.com]
   * @since DistributionVersion
   */
   ...
   * @return 实例对象
   */
  EmailBO queryById(Long id, Long uid);
   ...
   * @since DistributionVersion
   */
  EmailBO queryByNameAndPwd(String loginName, String loginPwd);
   ...
   * @since DistributionVersion
   */
  EmailBO queryByPhoneNumberAndSmsCode(String phoneNumber, String smsCode);
   ...
   *
   * @param userId 用户ID
   * @return java.util.List<EmailBO>
   * @author DingPengwei[www.dingpengwei@foxmail.com]
   * @since DistributionVersion
   */
  List<EmailBO> queryByUserId(Long userId);
