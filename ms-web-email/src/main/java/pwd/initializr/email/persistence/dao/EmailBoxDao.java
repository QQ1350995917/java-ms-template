...
public interface EmailBoxDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") EmailBoxEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<EmailBoxEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") EmailBoxEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<EmailBoxEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<EmailBoxEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  EmailBoxEntity queryById(@Param("id") Long id);
   ...
   */
  List<EmailBoxEntity> queryByEmailId(@Param("emailId") Long emailId);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") EmailBoxEntity entity);
}
