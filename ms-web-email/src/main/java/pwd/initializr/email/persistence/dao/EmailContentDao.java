...
public interface EmailContentDao {
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insert(@Param("entity") EmailContentEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertByBatch(@Param("entities") List<EmailContentEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplace(@Param("entity") EmailContentEntity entity);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer insertOrReplaceByBatch(@Param("entities") List<EmailContentEntity> entities);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  List<EmailContentEntity> queryByCondition(
   ...
   * @since 0.0.1-SNAPSHOT
   */
  EmailContentEntity queryById(@Param("id") Long id);
   ...
   */
  EmailContentEntity queryByEmailId(@Param("emailId") Long emailId);
   ...
   * @since 0.0.1-SNAPSHOT
   */
  Integer updateById(@Param("entity") EmailContentEntity entity);
}
