...
public interface EmailDao {
   ...
   * @return 对象列表
   */
  List<EmailEntity> queryAllByCondition(
   ...
   * @return 对象列表
   */
  List<EmailEntity> queryAllByUid(@Param("uid") Long uid);
   ...
   * @return 实例对象
   */
  EmailEntity queryById(@Param("id") Long id,@Param("uid") Long uid);
   ...
   * @return 实例对象
   */
  EmailEntity queryByLoginNameAndPwd(@Param("loginName") String loginName,
